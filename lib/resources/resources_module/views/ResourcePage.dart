...
class _ResourcePageState extends State<ResourcePage> {
  ...
  List<String> resource_type = ["Exams", "Lectures", "Assignments", "Tutorials", "Labs"];
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(15),
//                                border: Border.all(color: Color(0xff307B30), width: 1),
                                    color: _isClicked?Colors.white:Colors.grey[200],
                                  ),
                                  child: Text(
                                    file_type[index],
                                    style: GoogleFonts.montserrat(
                                        textStyle: TextStyle(
                                            color: _isClicked?Colors.white:Colors.orange,
                                            fontWeight: FontWeight.w300,
                                            fontSize: 16)),
                                  ),
                                ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                Text('System Programming Exam', style: TextStyle(color: Colors.white, fontSize: 25.0, fontWeight: FontWeight.w700),),
                                                Text('System Programming Exam 2010', style: TextStyle(color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.w400),),
                                              ],
                                            ),
...
//                        Navigator.of(context).pushNamed(MyEventDetail.routeName, arguments: myEvents[index]);
                          ...
                          child:Row(
                            children: [
                              ...
                              icon: Icon(Icons.favorite_border, color: Colors.red,size: 33,),
                              onPressed: (){
                                        ...
                                        child:Row(
                                          ...
                                          children: [
                                            ...
                                            IconButton(
                                              ...
                                              icon: Icon(Icons.comment,size: 33 ,color: Colors.black,),
                                              onPressed: (){
//                                            Get.toNamed('/comment');
                                                showDialog(context: context, builder: (BuildContext context){
                                                  return Comment();
                                                });
                                                SnackBar(content: Text("Download Icon"));
...
//                                            Text('Seats Available', style: TextStyle(color: Colors.white, fontSize: 15.0, fontWeight: FontWeight.w300),),
                                      ...
                                      Expanded(
                                        ...
                                        child:IconButton(
                                          ...
                                          icon: Icon(Icons.file_download, color: Colors.green,size: 33,),
                                          onPressed: (){
